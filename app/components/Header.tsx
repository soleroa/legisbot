      ...
      <div className="mx-auto flex h-full w-full max-w-3xl items-center justify-between px-4 md:px-6">
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            className="inline-flex items-center gap-1.5 rounded-full border border-border bg-secondary/70 px-3 py-1.5 text-xs font-medium text-secondary-foreground transition-colors hover:bg-secondary"
          >
            <FileText className="h-3.5 w-3.5" />
            <span className="hidden sm:inline">Generar informe</span>
          </button>
          <span className="hidden items-center gap-1.5 rounded-full border border-success/20 bg-success-muted px-2.5 py-1 text-xs font-medium text-success sm:inline-flex">
